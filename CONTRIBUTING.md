# Contributing to purl2notices

First off, thank you for considering contributing to purl2notices! It's people like you that make purl2notices such a great tool.
...
```bash
# Clone your fork
git clone https://github.com/your-username/purl2notices.git
cd purl2notices
...
```bash
# 1. Bump the version in pyproject.toml and purl2notices/__init__.py, add a CHANGELOG entry, merge it
...
Confirm the upload with the version-specific endpoint, `https://pypi.org/pypi/purl2notices/X.Y.Z/json`.
The aggregate `https://pypi.org/pypi/purl2notices/json` is cached and can lag a few minutes behind,
which looks like a failed upload when it is not.

## Community

You can chat with the community on:
- [GitHub Discussions](https://github.com/SemClone/purl2notices/discussions)
- [Issues](https://github.com/SemClone/purl2notices/issues)
